...
extension VisaMemoryDecodable {
    ...
    public func decode<D: VisaMemoryDecoder>(visaString string: String, with decoder: D) throws -> Self where D.DecodingType == Self {
